...
if response.status_code != 200:
    ...
    print("Please check your API key and parameters.")
#store json from sotrmglass
json_data = response.json()

hours = json_data.get("hours", [])
print(f"Number of hours extracted: {len(hours)}")
...
timezone = input("Eastern or Pacific time: ")
if timezone == "Eastern":
